...
const CAPITALS = [
  ["Afghanistan", "Kabul"], ["Argentina", "Buenos Aires"], ["Australia", "Canberra"], ["Austria", "Vienna"],
  ["Belgium", "Brussels"], ["Brazil", "Brasilia"], ["Canada", "Ottawa"], ["Chile", "Santiago"],
  ["China", "Beijing"], ["Colombia", "Bogota"], ["Denmark", "Copenhagen"], ["Egypt", "Cairo"],
  ["France", "Paris"], ["Germany", "Berlin"], ["Greece", "Athens"], ["India", "New Delhi"],
  ["Indonesia", "Jakarta"], ["Ireland", "Dublin"], ["Italy", "Rome"], ["Japan", "Tokyo"],
  ["Kenya", "Nairobi"], ["Mexico", "Mexico City"], ["Morocco", "Rabat"], ["Netherlands", "Amsterdam"],
  ["New Zealand", "Wellington"], ["Nigeria", "Abuja"], ["Norway", "Oslo"], ["Peru", "Lima"],
  ["Philippines", "Manila"], ["Poland", "Warsaw"], ["Portugal", "Lisbon"], ["Saudi Arabia", "Riyadh"],
  ["South Africa", "Pretoria"], ["South Korea", "Seoul"], ["Spain", "Madrid"], ["Sweden", "Stockholm"],
  ["Thailand", "Bangkok"], ["Turkey", "Ankara"], ["United Kingdom", "London"], ["United States", "Washington, D.C."]
];
...
function capitalDistractors(country) {
  return CAPITALS.filter(([name]) => name !== country).slice(0, 3).map(([, capital]) => capital);
}
...
function renderFacts() {
  ...
  els.sectionMeta.textContent = state.search
    ...
    : state.sort === "default"
      ? "Every category now has 20-50 real-world facts. The old generated number section has been removed."
