...
begin
  ...
  insert into public.pulse_league_sessions (profile_id, activity, minutes, note)
  values (p_profile_id, left(trim(coalesce(p_activity, 'Other')), 32), greatest(5, least(600, p_minutes)), left(coalesce(p_note, ''), 120))
  returning * into saved;
