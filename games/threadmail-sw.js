const THREADMAIL_CACHE = "threadmail-pwa-v61";
const THREADMAIL_ASSETS = [
  "./threadmail.html",
  "./threadmail.css?v=61",
  "./threadmail.webmanifest?v=61",
  "./threadmail-tm-icon-192.png",
  "./threadmail-tm-icon-512.png",
  "./threadmail-tm-preview.png",
  "../style.css",
  "../js/threadmail.js?v=61"
];
